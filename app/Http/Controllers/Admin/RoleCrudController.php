...
class RoleCrudController extends CrudController
{
    ...
    public function setupListOperation()
    {
        ...
        $this->crud->addColumn([
            'label'     => trans('permissionmanager.users'),
            'type'      => 'text',
            'name'      => 'users_count',
            'wrapper'   => [
            ...
            'suffix'    => ' '.strtolower(trans('permissionmanager.user')),
        ]);
        ...
        if (config('backpack.permissionmanager.multiple_guards')) {
            $this->crud->addColumn([
                'name'  => 'guard_name',
                'label' => trans('permissionmanager.guard_type'),
                'type'  => 'text',
            ]);
        }
        ...
        $this->crud->addColumn([
            ...
            'label'     => mb_ucfirst(trans('permissionmanager.permission_plural')),
